...
# ____________________ Generating and saving the 2nd set of RSA Public and Private Key
...
file1 = open('kr2.pem', 'wb')
file1.write(pem_kr)
file1.close()

file2 = open('ku2.pem', 'wb')
file2.write(pem_ku)
file2.close()
